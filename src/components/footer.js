    ...
    <div className="container">
      <div className="row">
        <div className="col-lg-4 col-md-8 col-sm-12">
          <img src={img} style={{ width: "130px" }} className="logo" alt="" />
          <div className="text">
            Opinta Solutions Pvt. Ltd. is certified by INVEST INDIA the
            "national investment promotion and facilitation agency" and endorsed
            by Centre for Innovation, Incubation and Linkages, Savitribai Phule
            Pune University.
          </div>
          <div
            style={{
        ...
        <div className="col-lg-2 col-md-4 col-sm-12">
          <h5 style={{ borderBottom: "1px solid #6E49B7" }}>Helpful Links</h5>
        ...
        <div className="col-lg-6 col-md-12 col-sm-12">
          <h5 style={{ borderBottom: "1px solid #6E49B7" }}>Our Offices</h5>
          <div className="row">
